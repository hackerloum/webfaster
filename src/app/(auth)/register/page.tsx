          ...
          >
            ...
            <div className="bg-white/[0.02] border border-white/[0.05] rounded-2xl p-6 sm:p-8 lg:p-10 backdrop-blur-xl">
              ...
              <div className="lg:hidden text-center mb-8">
                ...
                <p className="text-white/60">Start building amazing websites</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex items-start gap-3 py-2">
                  <input
                    ...
                    className="w-4 h-4 mt-0.5 rounded border-white/[0.08] bg-white/[0.03] text-purple-500 focus:ring-purple-500/20 cursor-pointer"
                  />
